...
4. **Cada chequeo nuevo se prueba por mutación, en las dos direcciones.**
   ...
   `mutaciones_tiradas.py` (19/19), `mutaciones_prerrequisitos.py` (10/10), `mutaciones_subida.py` (7/7), `mutaciones_nivel20.py` (37/37) y
...
10. **✅ CERRADA (2026-09-02) — la regla inviolable 6 ya no es prosa.**
   *(era 🔴 desde el 2026-08-31, el mismo día en que se escribió)*
   ...
   pudrirse. Y tiene su propia prueba por mutación: **37/37**.
...
python3 _verificacion/mutaciones_nivel20.py      # 37/37
